...
scale_width = (w) => {
    return parseInt(w*SCREEN_WIDTH*(SCREEN_HEIGHT+5000))/8500;
}
...
class QRScannerRectView extends Component {
    static defaultProps = {
        ...
        cornerColor: '#22ff00',
        borderColor: '#000000',
        rectHeight: scale_width(8.5),
        rectWidth: scale_width(9),
        borderWidth: 0,
        cornerBorderWidth: 4,
        ...
        scanBarMargin: 6,
        hintText: '',
        hintTextStyle: {color: '#fff', fontSize:getAdjustedFontSize(5.5), fontFailbackgroundColor:'transparent',...Platform.select({
         ios: { fontFamily: 'Arial', },
         android: { fontFamily: 'sans-serif' }
        })},
        hintTextPosition: scale_width(7.5),
        isShowScanBar:true
    };
        ...
        return (
            <View style={{flex: 1}}>
                ...
                >
                    ...
                    <View style={{justifyContent: 'center',alignItems:'center',height:"7%"}}>{this.props.renderBottomMenuView && this.props.renderBottomMenuView()}</View>
            </View>
        );
    }
}
